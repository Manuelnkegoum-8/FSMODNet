...
metainfo = {
    'ALL_CLASSES': ('person', 'car', 'bus', 'motorcycle', 'traffic light', 'truck'),
    'BASE_CLASSES': ('person', 'car', 'traffic light'),
    'NOVEL_CLASSES': ('bus', 'motorcycle', 'truck'),
    'mapping': {'person':0, 'car':1, 'bus':2, 'motorcycle':3, 'traffic light':4, 'truck':5},
    'palette': [
        (220, 20, 60),
        (0, 0, 142),
        (119, 11, 32),
...
metric = dict(
    ...
    stage='meta_learning',
    ann_file=root + 'Coco_annotations/val.json',
    metric='bbox',
)
...
custom_callbacks = [
    ...
    dict(type='VizualizationCallback', palette=metainfo['palette'], min_score_threshold=0.05, interval=100),
]
