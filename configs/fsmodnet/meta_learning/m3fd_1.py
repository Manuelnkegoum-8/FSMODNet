...
train_data = dict(
    ...
    root=root,
    ann_file='Coco_annotations/Train_Annotations2.json',
...
val_data = dict(
    type='Few_shot_CocoDetection_RGBT',
    root=root,
    ann_file='Coco_annotations/Val_Annotations2.json',
...
metric = dict(
    ...
    stage='meta_learning',
    ann_file=root + 'Coco_annotations/Val_Annotations2.json',
    metric='bbox',
)
