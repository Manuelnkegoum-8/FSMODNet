_base_ = [ '../meta_learning/dinov3.py',]
...
custom_callbacks = [
        ...
        dict(type='VizualizationCallback', save_dir='visualization', palette=_base_.metainfo['palette'], min_score_threshold=0.35, interval=10),
